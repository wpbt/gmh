...
register_activation_hook(__FILE__, [\GhostMediaHunter\Services\Activate::class, 'run']);
register_deactivation_hook(__FILE__, [\GhostMediaHunter\Services\Deactivate::class, 'run']);

function ghostmediahunter()
{
