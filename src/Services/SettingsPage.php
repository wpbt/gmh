...
class SettingsPage implements Registrable
{
    ...
    {
        register_setting(self::OPTION_GROUP, ScanRestController::OPTION_KEY, [
            'type'              => 'string',
            'sanitize_callback' => [$this, 'sanitize_scan_key'],
            'default'           => '',
        ]);
        ...
        add_settings_section(
            ...
            [$this, 'render_rest_section_intro'],
            self::SLUG
        );
        ...
        add_settings_field(
            ...
            [$this, 'render_scan_key_field'],
            self::SLUG,
            self::REST_SECTION
        );

        register_setting(self::OPTION_GROUP, self::KEYWORDS_OPTION, [
            'type'              => 'array',
        ...
        add_settings_section(
            ...
            [$this, 'render_checker_section_intro'],
            self::SLUG
        );
    ...
    public function render_page(): void
    {
        ...
        include GHOST_MEDIA_HUNTER_PATH . 'views/settings-page.php';
    }
}